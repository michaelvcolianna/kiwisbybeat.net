        ...
        <ul className={styles.pageNav}>
          <li className={styles.previous}>
            <PageLink href={previous}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" height="1" width="0.625"><path fill="currentColor" d="M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/></svg>
          ...
          <li className={styles.next}>
            <PageLink href={next} className={styles.next}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" height="1" width="0.625"><path fill="currentColor" d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg>
            </PageLink>
          </li>
        </ul>
      </nav>
